...
export function AddPhotos({ user, backHandler, nextHandler, actionHandler }) {
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        <View>
          ...
          <Text style={styles.textStyle}>
            You can add more & change these later.
          </Text>
          ...
          <View style={styles.photosRow}>
                    ...
                    <View key={index} style={styles.photosCol}>
                      <ImageBackground
                        ...
                        <Pressable
                          ...
                          <Image
                            style={styles.deletePhotos}
                            source={require('../../../assets/images/assets/delete.png')}
                          />
                        </Pressable>
                      </ImageBackground>
                    </View>
            ...
            {images.length < 2 ? (
              <Pressable
                style={styles.photosColAdd}
                onPress={() => {
                  setVisible(true)
                }}>
                <View>
                  <Image
                    source={require('../../../assets/images/assets/plus.png')}
                  />
                </View>
              </Pressable>
            ) : null}
      ...
      <AddPhotosModal
        visible={visible}
        pickedImageHandler={pickedImageHandler}
