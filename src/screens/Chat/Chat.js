import { View, Text, StyleSheet, Dimensions, SafeAreaView, TouchableOpacity, Image, TextInput, ScrollView, KeyboardAvoidingView, Platform } from 'react-native';
...
export default function Chat({ navigation }) {
  ...
  const [messageArray, setMessageArray] = useState([
    ...
    {
      isSender: false,
      message: 'In general, everything is fine, but sometimes there is a feeling of anxiety I will try',
      time: '12:45',
      unRead: true,
      today: false,
    },
          ...
          <View style={styles.inputView}>
            ...
            <TextInput
              ...
              style={[styles.textInput, {
                ...
                width: message == '' && screenWidth.width60 || screenWidth.width70
              }]}
            />
            {message == '' &&
