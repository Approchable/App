import {View, Text, StyleSheet, Dimensions, SafeAreaView, TouchableOpacity, Image, TextInput, ScrollView} from 'react-native';
...
import { ColorSet, ImageSet, Routes, screenWidth } from '../../components/config/Constant';
...
export default function Chat({navigation}) {
  ...
  return (
    ...
    <ScrollView contentContainerStyle={{flex:1, justifyContent:'flex-end', paddingBottom:10,}}>
        ...
        <View style={styles.rightMessageView}>
          <View style={styles.rightMessageText}>
            ...
            Amet minim mollit non deserunt ull..?
            </Text>
          </View>
        </View>
        ...
        <View style={styles.leftMessageView}>
          <View style={styles.leftMessageText}>
            <Text style={styles.messagesText}>
            In general, everything is fine, but sometimes 
              there is a feeling of anxiety I will try,  In general, everything is fine, but sometimes 
              there is a feeling of anxiety I will try, In general, everything is fine, but sometimes 
              there is a feeling of anxiety I will try, In general, everything is fine, but sometimes 
              there is a feeling of anxiety I will try. In general, everything is fine, but sometimes 
              there is a feeling of anxiety I will try. In general, everything is fine, but sometimes 
              there is a feeling of anxiety I will try
            </Text>
            <Text style={[styles.dateLabelText, {marginLeft:10, alignSelf:'flex-end'}]}>
              12:45
            </Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  messagesText:{
    ...
    maxWidth: screenWidth.width75 + 10,
  },
  rightMessageView:{
    flexDirection:'row',
    paddingHorizontal:20,
